...
<img src="https://img.youtube.com/vi/tgr0kjX5Q0Q/maxresdefault.jpg"
...
<div style="background: #161b22; padding: 15px; border-radius: 8px; border-left: 5px solid #6e7681; margin-bottom: 30px; font-style: italic; font-size: 0.95em; color: #c9d1d9; line-height: 1.5;">
  "My workflow prioritizes a systems first. I begin with functional blockouts and networked state before integrating final art assets, custom iconography, and motion graphics."
</div>
